...
if s:t_Co >= 256
  ...
  "hi Search ctermfg=NONE ctermbg=239 cterm=underline
  "hi IncSearch ctermfg=NONE ctermbg=237 cterm=underline
  hi Search ctermfg=73 ctermbg=239 cterm=underline
  hi IncSearch ctermfg=73 ctermbg=239 cterm=underline
  "hi MatchParen ctermfg=NONE ctermbg=NONE cterm=bold
  hi MatchParen ctermfg=NONE ctermbg=97 cterm=bold
